...
typedef enum
{
   ...
   /*!
    ...
    /*! The specified Timer BCN Master event type is not valid. */
    NCP_ST_TIMER_BCN_INVALID_EVENT             = 1719,
    /*! The specified Timer BCN Master trigger type is not valid. */
    NCP_ST_TIMER_BCN_INVALID_TRIGGER_TYPE      = 1720,
    /*! The specified Timer BCN Master capture target is not valid. */
    NCP_ST_TIMER_BCN_INVALID_CAPTURE_TARGET    = 1721,
    /*! The specified Timer BCN Master match value is not valid. */
    NCP_ST_TIMER_BCN_INVALID_MATCH_VALUE       = 1722,
    /*! The specified Timer BCN Master match index is not valid. */
    NCP_ST_TIMER_BCN_INVALID_MATCH_INDEX       = 1723,
    /*! The specified Timer BCN Master Timer pulse is invalid. */
    NCP_ST_TIMER_BCN_INVALID_PULSE             = 1724,
    /*! The specified Timer BCN Master Timer is already enabled. */
    NCP_ST_TIMER_BCN_TIMER_ENABLED             = 1725,
    /*! The specified Timer BCN Master Timer is already disabled. */
    NCP_ST_TIMER_BCN_TIMER_DISABLED            = 1726,
    /*! The Timer BCN Master is already enabled. */
    NCP_ST_TIMER_BCN_MASTER_ENABLED            = 1727,
    /*! The Timer BCN Master is already disabled. */
    NCP_ST_TIMER_BCN_MASTER_DISABLED           = 1728,
    /*! The FCB encoder is already enabled. */
    NCP_ST_TIMER_BCN_FCB_ENABLED               = 1729,
    /*! The FCB encoder is already disabled. */
    NCP_ST_TIMER_BCN_FCB_DISABLED              = 1730,
    ...
    /*! Fixed pool invalid block id */
    NCP_ST_MME_FIXPOOL_INVALID_BLKID            = 2014,
    /*! Fixed pool buffer registration failed */
    ...
    /*! Fixed pool alloation failed due to boundary check not
        being able to be satisfied. */
    NCP_ST_MME_FIXPOOL_ALLOC_BOUNDARY_ERR       = 2017,
   /*! Fixed pool buffer free error. couldn't insert.. */
    NCP_ST_MME_FIXPOOL_FREE_ERROR               = 2018,
   /*! Fixed pool buffer register. Address not in range.. */
    NCP_ST_MME_FIXPOOL_REGISTER_ADDR_NOT_IN_RANGE = 2019,
   /*! Fixed pool operation; ncp_malloc() failure.. */
    NCP_ST_MME_FIXPOOL_ALLOC_FAILURE            = 2020,
   /*! Fixed pool buffer not in used list. */
    NCP_ST_MME_FIXPOOL_NOT_IN_USED_LIST         = 2021,
   /*! Fixed pool buffer address is already in use. */
    NCP_ST_MME_FIXPOOL_ADDR_IN_USE              = 2022,
   /*! Fixed pool buffer in use as Rx. Cannot register for Rx again. */
   ...
   /*! Found in used pool but size not matching */
    ...
    /*! The PB initialization routine failed */
    NCP_ST_PB_INIT_FAILED                      = 2102,
    /*! The TQ initialization routine failed */
    NCP_ST_TQ_INIT_FAILED                      = 2103,
    ...
    /*!
     * Mode task buffer is NULL.
     */
    NCP_ST_COW_INVALID_MODE_TASK_BUFFER            = 2742, /*!< */

    /*!
     * Number of items buffer is NULL.
     */
    NCP_ST_COW_INVALID_NUM_ITEMS_BUFFER            = 2743, /*!< */

    /*!
     * Task Queue is not mapped to any logical queue.
     */
    NCP_ST_COW_TASKQ_NOT_MAPPED                    = 2744, /*!< */

    /*!
     * BCN Slave is already enabled.
     */
    NCP_ST_COW_BCN_SLAVE_ENABLED                   = 2745, /*!< */

    /*!
     * BCN Slave is disabled.
     */
    NCP_ST_COW_BCN_SLAVE_DISABLED                  = 2746, /*!< */

    /*!
     * An invalid BCN Slave capture target is specified.
     */
    NCP_ST_COW_BCN_SLAVE_INVALID_CAPTURE_TARGET    = 2747, /*!< */

    /*!
     * An invalid strict priority arbitration work conserve selection.
     */
    NCP_ST_COW_INVALID_SP_ARB_WORK_CONSERVE_SEL    = 2748, /*!< */
    ...
    */
    ...
    /*!
     * Invalid owner process id for poolLock
     */
    /* NCP_ST_TASK_BAD_POOL_OWNER_PROCESS         = 3519, */
    ...
    /*! The unscheduled queue pop returned 0, for a queue that only contains
     *  task headers. Hence, the unscheduled queue is empty. */
    /* NCP_ST_TASK_UNSCHEDULED_QUEUE_IS_EMPTY              = 3794, */
    /*! The unscheduled queue does not have a corresponding receive queue
     *  profile. */
    NCP_ST_TASK_UNSCHEDULED_QUEUE_HAS_NO_QUEUE_PROFILE  = 3795,
    /*! Process tries to allocate TQS which is PROCESS_PRIVATE for another PID */
    /* NCP_ST_TASK_PID_MISMATCH                            = 3796, */
    /*! The RTE detected that the process crashed while at least one thread was
     * in the RTE. ncp_task_process_crash() cannot recover task I/O state or
     * CPU pools; instead the device must be reconfigured.
     */
    NCP_ST_TASK_RTE_RESET_REQUIRED                      = 3797,
   ...
   */
    ...
    * sysmem but not the other */
    ...
    NCP_ST_EIOA_INVALID_MASK_VALUE          = 4245,
    /*!< The mask value specified is invalid for the port type. */
    NCP_ST_EIOA_PORT_SWITCHOVER_IN_PROGRESS       = 4246,
    /*!< Port switchover is in progress. */
    NCP_ST_EIOA_INVALID_ISB                      = 4247,
    /*!< ISB called with invalid node id. */
    NCP_ST_EIOA_MCAST_TBL_ADDR_ERROR             = 4248,
    /*!< Invalid Multicast Table Address. */
    NCP_ST_EIOA_FUNC_HDLR_NOT_DEFINED            = 4249,
    /*!< EIOA function handler not defined. */
    NCP_ST_EIOA_FUNC_CODE_INVALID                = 4250,
    /*!< EIOA function code is invalid. */
    NCP_ST_EIOA_HSS_RIF_HSS_CONFLICT                = 4251,
    /*!< EIOA-interface and RIF-link cannot use same SerDes */
    NCP_ST_EIOA_SWITCHOVER_ISR_ACTIVE_RETRY_EXCEEDED = 4252,
    /*!< EIOA switchover isr active retry exceeded */
    ...
    NCP_ST_EIOA_HSS_INVALID_TIMER_VALUE          = 4473, /*!< HSS Timer value below minimum for selected rate */
    ...
    NCP_ST_NRCP_APLL_LOCK_TIMEOUT                = 5004, /*!< the NRCP Analog PLL did not achieve lock */
    NCP_ST_NRCP_DPLL_FAST_ACQ_LOCK_TIMEOUT       = 5005, /*!< the NRCP DPLL did not achieve lock in fast acq mode */
    NCP_ST_NRCP_DPLL_NORM_ACQ_LOCK_TIMEOUT       = 5006, /*!< the NRCP DPLL did not achieve lock in normal acq mode */
    NCP_ST_NRCP_INVALID_REF_FREQ_FOR_BYPASS      = 5007, /*!< configuration requested DPLL with an invalid reference frequency (must be 25MHz) */
    NCP_ST_NRCP_INVALID_REF_CLK                  = 5008,
    NCP_ST_NRCP_INVALID_BYP_CLK                  = 5009,
    NCP_ST_NRCP_INVALID_CLK_OUT                  = 5010,
    NCP_ST_NRCP_INVALID_ETH_CLK_OUT              = 5011,
    NCP_ST_NRCP_INVALID_REF_FREQ                 = 5012,
    NCP_ST_NRCP_INVALID_DPLL_SEL                 = 5013, 
    NCP_ST_NRCP_INVALID_HOLDOVER_MODE            = 5014,
    NCP_ST_NRCP_INVALID_ACQ_MODE                 = 5015,
    NCP_ST_NRCP_EEC_MODE_CHANGE_NEEDS_RESET      = 5016,
    NCP_ST_NRCP_HOLDOVER_MODE_CHANGE_NEEDS_RESET = 5017,
    NCP_ST_NRCP_INVALID_REF_CLK_MAC_CHAN         = 5018,
    NCP_ST_NRCP_INVALID_BYP_CLK_MAC_CHAN         = 5019,
    ...
    /*! There was an error using mmap/munmap. */
    NCP_ST_DSP_MMAP_ERROR                        = 5214,
    /*! An invalid DSP interrupt was specified. */
    NCP_ST_DSP_INVALID_INTERRUPT_ID              = 5215,
    /*! The interrupt is already cleared. */
    NCP_ST_DSP_INTERRUPT_CLEARED                 = 5216,
    /*! The interrupt is already set. */
    NCP_ST_DSP_INTERRUPT_SET                     = 5217,
    /*! The interrupt is not enabled. */
    NCP_ST_DSP_INTERRUPT_NOT_ENABLED             = 5218,
    /*! The specified cluster ID is invalid. */
    NCP_ST_DSP_INVALID_CLUSTER_ID                = 5219,
    ...
    /*!< The LTEFE application profile is invalid */
    NCP_ST_LTEFE_INVALID_APPLICATION_PROFILE     = 5307,
    /*! The specified core ID is invalid. */
    NCP_ST_LTEFE_INVALID_CORE_ID                 = 5308,
    /*! The specified core is already loaded. */
    NCP_ST_LTEFE_CORE_LOADED                     = 5309,
    /*! The specified core ID is already unloaded. */
    NCP_ST_LTEFE_CORE_UNLOADED                   = 5310,
    /*! The cluster for the specified core is running. */
    NCP_ST_LTEFE_CLUSTER_IS_RUNNING              = 5311,
    /*! The cluster for the specified core is not running. */
    NCP_ST_LTEFE_CLUSTER_NOT_RUNNING             = 5312,
    /*! No cores are loaded for the specified cluster. */
    NCP_ST_LTEFE_NO_CORES_LOADED                 = 5313,
    /*! The specified interrupt ID is invalid. */
    NCP_ST_LTEFE_INVALID_INTERRUPT_ID            = 5314,
    ...
    /*! Either no space left for AxC or not enough slots to fit the width available */
    NCP_ST_RIF_AXC_WIDTH_CANNOT_BE_ACCOMODATED = 5556,

    /*! Invalid start of buffer mode */
    NCP_ST_RIF_SW_TRIG_INVALID_SOB_MODE = 5557,

    /*! Invalid sequence count mode */
    NCP_ST_RIF_INVALID_BUFFER_SEQ_COUNT_MODE = 5558,

    /*! Invalid compression mode */
    NCP_ST_RIF_INVALID_COMPRESSION_MODE = 5559,

    /*! Invalid RP3-Timestamp mode */
    NCP_ST_RIF_INVALID_RP3_TSTAMP_MODE = 5560,

    /*! Invalid RP3-HW Address */
    NCP_ST_RIF_INVALID_RP3_HWADDR = 5561,

    /*! Invalid RP3-Timestamp value */
    NCP_ST_RIF_INVALID_RP3_TSTAMP_VAL = 5562,

    /*! Invalid RP3-Type */
    NCP_ST_RIF_INVALID_RP3_TYPE = 5563,

    /*! Invalid threshold index valid:0-7 */
    NCP_ST_RIF_INVALID_THRESHOLD_INDEX = 5564,

    /*! Invalid RP3 Type mask value */
    NCP_ST_RIF_INVALID_RP3_TYPE_MASK = 5565,

    /*! JESD link can have only DATA */
    NCP_ST_RIF_STREAM_JESD_AXC_NOT_DATA = 5566,
    /*! Invalid VSB Segment Mode specification */
    NCP_ST_RIF_INVALID_AXC_VSB_SEG_MODE = 5567,

    /*! Invalid RP3 PRBS Mode */
    NCP_ST_RIF_INVALID_RP3_PRBS_MODE = 5568,
    /*! Invalid RP3 MFB Window Size */
    NCP_ST_RIF_INVALID_RP3_MFB_WINDOW_SIZE = 5569,
    /*! Invalid RP3 RTT Offset */
    NCP_ST_RIF_INVALID_RP3_RTT_OFFSET = 5570,
    /*! Invalid RP3 Link Rate */
    NCP_ST_RIF_INVALID_RP3_LINK_RATE = 5571,
    /*! Invalid RP3 MF Rel Select */
    NCP_ST_RIF_INVALID_RP3_MF_REF_SEL = 5572,
    /*! Invalid RP3 MF Counter Mode */
    NCP_ST_RIF_INVALID_RP3_MF_COUNTER_MODE = 5573,
    /*! Invalid RP3 CAR Type */
    NCP_ST_RIF_INVALID_CAR_TYPE = 5574,
    /*! Invalid RP3 Sync Mode */
    NCP_ST_RIF_INVALID_RP3_SYNC_MODE = 5575,
    /*! Invalid RP3 SFN C1 Counter mode */
    NCP_ST_RIF_INVALID_RP3_SFN_C1_CAPTURE = 5576,
    /*! Invalid RP3 Map Rx Threshold */
    NCP_ST_RIF_INVALID_RP3_MAP_RX_THRESHOLD = 5577,
    /*! Invalid RP3 Interface Select */
    NCP_ST_RIF_INVALID_RP3_INTF_SELECT = 5578,
    /*! Invalid RP3 Frame Sync Mode */
    NCP_ST_RIF_INVALID_RP3_FRAME_SYNC_MODE = 5579,
    /*! Invalid RP3 Map Tx Threshold */
    NCP_ST_RIF_INVALID_RP3_MAP_TX_THRESHOLD = 5580,
    /*! Invalid RP3 Scrambler Seed */
    NCP_ST_RIF_INVALID_RP3_SCRAMBLER_SEED = 5581,
    /*! Invalid RP3 Tx Bit Level Delay */
    NCP_ST_RIF_INVALID_RP3_TX_BIT_LEVEL_DELAY = 5582,
    /*! Invalid RP3 external synch buffer delay */
    NCP_ST_RIF_INVALID_RP3_EXT_SYNCH_BUF_DELAY = 5583,
    /*! Invalid RP3 Address */
    NCP_ST_RIF_INVALID_RP3_ADDRESS = 5584,
    /*! Invalid RP3 RX Slot Value */
    NCP_ST_RIF_INVALID_RP3_RX_SLOT_VALUE = 5585,
    /*! Invalid RP3 RX Start Window Length */
    NCP_ST_RIF_INVALID_RP3_RX_START_WINDOW_LENGTH = 5586,
    /*! Invalid RP3 RX Window Enable */
    NCP_ST_RIF_INVALID_RP3_RX_WINDOW_ENABLE = 5587,
    /*! Invalid RP3 Tx Mode */
    NCP_ST_RIF_INVALID_RP3_TX_MODE = 5588,
    /*! Invalid RP3 Tx Rule Index */
    NCP_ST_RIF_INVALID_RP3_TX_RULE_INDEX = 5589,
    /*! Invalid RP3 Tx Link */
    NCP_ST_RIF_INVALID_RP3_TX_LINK = 5590,
    /*! Invalid RP3 TX Slot Value */
    NCP_ST_RIF_INVALID_RP3_TX_SLOT_VALUE = 5591,
    /*! Invalid RP3 Link Slot Type */
    NCP_ST_RIF_INVALID_RP3_LINK_SLOT_TYPE = 5592,
    /*! RP3 Must Enable at-least one transmissionsRule Map for Data */
    NCP_ST_RIF_RP3_ENABLE_ATLEAST_ONE_TX_RULE = 5593,
    /*! Invalid VSB index or data start HFN */
    NCP_ST_RIF_INVALID_VSB_DATA_START_HFN = 5594,
    /*! Invalid VSB Modulo HFN */
    NCP_ST_RIF_INVALID_VSB_MODULO_HFN = 5595,
    /*! Invalid RP3 Link Modulo */
    NCP_ST_RIF_INVALID_RP3_LINK_MODULO = 5596,
    /*! Link Level Ethernet Fast Channel not enabled */
    NCP_ST_RIF_LINK_ETH_FAST_CHANNEL_NOT_ENABLED = 5597,
    /*! Link Level Hdlc Slow Channel not enabled */
    NCP_ST_RIF_LINK_HDLC_SLOW_CHANNEL_NOT_ENABLED = 5598,
    /*! Invalid RP3 Eth Byte Alignment Control Offset */
    NCP_ST_RIF_INVALID_RP3_ETH_ALIGN = 5599,
    /*! Invalid RP3 Control Modulo */
    NCP_ST_RIF_INVALID_RP3_CONTROL_MODULO = 5600,
    /*! RP3 Must Enable at-least one Control Message transmissionsRule Map for Control */
    NCP_ST_RIF_RP3_ENABLE_ATLEAST_ONE_TX_CONTROL_RULE = 5601,
    /*! RP3 Invalid FCB Tx period specification */
    NCP_ST_RIF_INVALID_RP3_FCB_TX_PERIOD = 5602,
    /*! RP3 Link Level Ethernet Messaging support not enabled */
    NCP_ST_RIF_LINK_RP3_ETH_MESSAGE_SUPPORT_NOT_ENABLED = 5603,
    /*! RP3 Invalid timestamp */
    NCP_ST_RIF_INVALID_RP3_TIMESTAMP = 5604,
    /*! RP3 Link Level Control Messaging support not enabled */
    NCP_ST_RIF_LINK_RP3_CONTROL_MESSAGE_SUPPORT_NOT_ENABLED = 5605,
    /*! Invalid RP3 Dual Bit Map 1 Size */
    NCP_ST_RIF_INVALID_RP3_BIT_MAP_1_SIZE = 5606,
    /*! Invalid RP3 Dual Bit Map 2 Size */
    NCP_ST_RIF_INVALID_RP3_BIT_MAP_2_SIZE = 5607,
    /*! Invalid RP3 AxC Modulo Rule Index */
    NCP_ST_RIF_RP3_INVALID_AXC_MODULO_RULE_INDEX = 5608,
    /*! Invalid RP3 CAR Clk */
    NCP_ST_RIF_INVALID_CAR_CLK = 5609,
    /*! Invalid SERDES Primary Clock Input Source Selection */
    NCP_ST_RIF_INVALID_SERDES_PRIMARY_CLOCK_INPUT_SOURCE_SEL	= 5610,
    /*! Invalid JESD numLanes */
    NCP_ST_RIF_INVALID_JESD_NUM_LANES	= 5611,
    /*! Invalid JESD numFramesPerMultiFrame */
    NCP_ST_RIF_INVALID_JESD_NUM_FRAMES_PER_MULTI_FRAME	= 5612,
    /*! Invalid JESD numConvertersPerDevice */
    NCP_ST_RIF_INVALID_JESD_NUM_CONVERTERS_PER_DEVICE	= 5613,
    /*! Invalid JESD numBitsPerSample */
    NCP_ST_RIF_INVALID_JESD_NUM_BITS_PER_SAMPLE	= 5614,
    /*! Invalid JESD numOctetsPerFrame */
    NCP_ST_RIF_INVALID_JESD_NUM_OCTETS_PER_FRAME	= 5615,
    /*! Invalid JESD numControlBitsPerSample */
    NCP_ST_RIF_INVALID_JESD_NUM_CONTROL_BITS_PER_SAMPLE	= 5616,
    /*! Invalid JESD subClass */
    NCP_ST_RIF_INVALID_JESD_SUB_CLASS	= 5617,
    /*! Invalid JESD timeTrigger */
    NCP_ST_RIF_INVALID_JESD_TIME_TRIGGER	= 5618,
    /*! Invalid JESD sysrefDelay */
    NCP_ST_RIF_INVALID_JESD_SYSREFDELAY	= 5619,
    /*! Invalid JESD fifoWatermarkLow */
    NCP_ST_RIF_INVALID_JESD_FIFOWATERMARKLOW	= 5620,
    /*! Invalid JESD fifoWatermarkHigh */
    NCP_ST_RIF_INVALID_JESD_FIFOWATERMARKHIGH	= 5621,
    /*! Invalid Mac channel */
    NCP_ST_RIF_INVALID_RIF_MAC_CHAN = 5622,
    /*! Invalid Mac channel */
    NCP_ST_RIF_MAC_CHNL_NOT_MAPPED = 5623,
    /*! There can only be 1 AxC BER for test sample purposes */
    NCP_ST_RIF_AXC_BER_TOBE_TEST_SAMPLED_ALREADY_USED_UP = 5624,
    /*! Sample and Hold Trigger timeout waiting */
    NCP_ST_RIF_LINK_SAMPLE_AND_HOLD_TRIGGER_WAITING = 5625,
    /*! Rx Measurement status is not valid */
    NCP_ST_RIF_LINK_RX_PHASE_MEASUREMENT_NOT_VALID = 5626,
    /*! Tx Measurement status is not valid */
    NCP_ST_RIF_LINK_TX_PHASE_MEASUREMENT_NOT_VALID = 5627,
    /*! Sample and Hold Trigger timeout waiting in OneShot Mode */
    NCP_ST_RIF_LINK_SAMPLE_AND_HOLD_TRIGGER_WAITING_IN_ONESHOT_MODE = 5628,
    ...
    /*! ERIF stream is a secondary stream */
    NCP_ST_ERIF_STREAM_IS_SECONDARY         = 5929,
    /*! ERIF feature not supported. */
    NCP_ST_ERIF_FEATURE_NOT_SUPPORTED       = 5930,
    /*! Invalid number of unit bits. Valid range: 6-20. */
    NCP_ST_ERIF_INVALID_NUM_UNIT_BITS       = 5931,
    /*! Invalid number of sunit bits. Valid range: 8-22. */
    NCP_ST_ERIF_INVALID_NUM_SUNIT_BITS      = 5932,
    /*! Invalid number of unit/sunit bits. unit + sunit bits != 28. */
    NCP_ST_ERIF_INVALID_NUM_UNIT_SUNIT_BITS = 5933,
    /*! ERIF Virtual buffer frame TTI select is invalid. */
    NCP_ST_ERIF_INVALID_VIRTUAL_BUF_FRAME_TTI_SELECT = 5934,
    /*! ERIF Vitual buffer length is invalid. */
    NCP_ST_ERIF_INVALID_VIRTUAL_BUF_LEN     = 5935,
    /*! ERIF Symbol timing reference index is invalid. */
    NCP_ST_ERIF_INVALID_SYMBOL_TIMING_REF_INDEX = 5936,
    /*! ERIF BIP sub buffer max range is invalid. */
    NCP_ST_ERIF_INVALID_BIP_SB_MAX_RANGE    = 5937,
    /*! ERIF frame initial value is invalid. */
    NCP_ST_ERIF_INVALID_FRAME_INITIAL_VALUE = 5938,
    /*! ERIF TTI initial value is invalid. */
    NCP_ST_ERIF_INVALID_TTI_INITIAL_VALUE   = 5939,
    /*! ERIF frame match value is invalid. */
    NCP_ST_ERIF_INVALID_FRAME_MATCH_VALUE   = 5940,
    /*! ERIF TTI match value is invalid. */
    NCP_ST_ERIF_INVALID_TTI_MATCH_VALUE     = 5941,
    /*! ERIF free match value is invalid. */
    NCP_ST_ERIF_INVALID_FREE_MATCH_VALUE    = 5942,
    /*! ERIF FRAME/TTI/Free value is invalid. */
    NCP_ST_ERIF_INVALID_FRAME_TTI_FREE_VALUE     = 5943,
    /*! ERIF FRAME/TTI generation mode is invalid. */
    NCP_ST_ERIF_INVALID_FRAME_TTI_GENERATION_MODE  = 5944,
    /*! ERIF HW sequencer index is invalid. */
    NCP_ST_ERIF_INVALID_HW_SEQUENCER_INDEX  = 5945,
    /*! ERIF Initial BIP offset is invalid. */
    NCP_ST_ERIF_INVALID_BIP_OFFSET          = 5946,
    /*! ERIF system memory base address offset is invalid. */
    NCP_ST_ERIF_INVALID_BASE_ADDR_OFFSET    = 5947,
    /*! ERIF sub buffer number wrap is invalid. */
    NCP_ST_ERIF_INVALID_SB_NUM_WRAP         = 5948,
    /*! ERIF stream limit reached for largeQueue fifo usage */
    NCP_ST_ERIF_SW_TRIG_LARGE_QUEUE_FIFO_STREAM_CNT_EXCEED = 5949,
    /*! ERIF not configured yet. */
    NCP_ST_ERIF_NOT_CONFIGURED = 5950,
    /*! All stream Ids are provisioned in the system. 
	no more free stream Ids available */
    NCP_ST_ERIF_MAX_STREAM_LIMIT_REACHED		= 5951,
    /*! Sub-buffer size and number of buffers provided 
	don't satisfy 16K boundary crossing requirement */
    NCP_ST_ERIF_STREAM_PTR_MODE_BUFFER_BOUNDARY_ERR 	= 5956,
    /*! AUTO calculation not supported. */
    NCP_ST_ERIF_AUTO_CALC_NOT_SUPPORTED 		= 5957,
    /*! No free multicopy ram entry is available. */
    NCP_ST_ERIF_NO_FREE_MULTICOPY_RAM_ENTRY = 5958,

    /*! AGGR_ID invalid */
    NCP_ST_ERIF_INVALID_AGGR_ID = 5959,

    /*! AGGR_ID already exists */
    NCP_ST_ERIF_AGGR_ID_EXISTS  = 5960,

    /*! AGGR_ID not created yet*/
    NCP_ST_ERIF_AGGR_NOT_PRESENT = 5961,

    /*! invalid Aggregator window size */
    NCP_ST_ERIF_AGGR_INVALID_WINDOW_MODE = 5962,

    /*! invalid Terminal count value */
    NCP_ST_ERIF_AGGR_INVALID_TERMINAL_CNT_VAL = 5963,

    /*! invalid Terminal count value */
    NCP_ST_ERIF_AGGR_INVALID_TERMINAL_CNT_SEL = 5964,

    /*! invalid stream count */
    NCP_ST_ERIF_AGGR_INVALID_STREAM_CNT = 5965,

    /*! max limit reached */
    NCP_ST_ERIF_AGGR_MAX_LIMIT_REACHED = 5966,

    /*! stream not created being added to aggregation */
    NCP_ST_ERIF_AGGR_STREAM_NOT_CREATED = 5967,

    /*! Aggregator supports only RMWA types now */
    NCP_ST_ERIF_AGGR_SUPPORTED_ONLY_FOR_RMWA= 5968,

    /*! mismatch of seconday stream configuration */
    NCP_ST_ERIF_SEC_STREAM_CFG_MISMATCH = 5969,

    /*! SW trigger mode is invalid in concat mode */
    NCP_ST_ERIF_CONCAT_MODE_SW_TRIGGER_INVALID = 5970,

    /*! Egress options table index is invalid. */
    NCP_ST_ERIF_EGRESS_OPTIONS_INDEX_INVALID = 5971,
    /*! Bip Map exists. */
    NCP_ST_ERIF_STREAM_BIP_MAP_EXISTS = 5972,

    /*! Egress options table entry for the index is not configured. */
    NCP_ST_ERIF_EGRESS_OPTIONS_INDEX_NOT_CONFIGURED = 5973,

    /*! number of streams in multicopy bundle has tobe <=5 */
    NCP_ST_ERIF_INVALID_NUM_MULTICOPY_STREAMS = 5974,

    /*! mapping does not exist for the stream to be enabled. */
    NCP_ST_ERIF_STREAM_BIP_MAP_DOES_NOT_EXIST = 5975,

    /*! A stream can be part of only one concat bundle */
    NCP_ST_ERIF_SEC_CONCAT_STREAM_ALREADY_MAPPED = 5976,

    /*! Stream is not part of aggregator */
    NCP_ST_ERIF_AGGR_STREAM_NOT_PRESENT = 5977,

    /*! Invalid BLOCK Transfer Engine Id (valid:0-31) */
    NCP_ST_ERIF_INVALID_BLOCK_TRANSFER_ENG_ID = 5978,

    /*! Block Transfer Engine not present */
    NCP_ST_ERIF_BLOCK_TRANSFER_ENG_NOT_PRESENT = 5979,

    /*! Block Transfer Engine already present*/
    NCP_ST_ERIF_BLOCK_TRANSFER_ENG_EXISTS = 5980,

    /*! Block Transfer Engine limit reached. */
    NCP_ST_ERIF_BLOCK_TRANSFER_ENG_MAX_LIMIT_REACHED = 5981,

    /*! Block Transfer Engine threshold invalid . */
    NCP_ST_ERIF_BLOCK_TRANSFER_INVALID_THRESHOLD_INDEX = 5982,

    /*! Block Transfer Engine invalid bip size. */
    NCP_ST_ERIF_INVALID_BIP_SIZE = 5983,

    /*! Aggregator enabled, some operations are not valid . */
    NCP_ST_ERIF_AGGR_ENABLED = 5984,

    /*! Invalid AXI Size in the descriptor */
    NCP_ST_ERIF_INVALID_AXI_SIZE = 5985,

    /*! Invalid Length in the descriptor */
    NCP_ST_ERIF_INVALID_LENGTH = 5986,

    /*! Invalid AXI Offset */
    NCP_ST_ERIF_INVALID_AXI_OFFSET = 5987,

    /*! Invalid RMWA Buffer Done event */
    NCP_ST_ERIF_INVALID_RMWA_BUFFER_DONE_EVENT_TYPE = 5988,

    /*! Invalid VLAN Tag Count */
    NCP_ST_ERIF_INVALID_VLAN_TAG_CNT = 5989,

    /*! Invalid MPLS Label Count */
    NCP_ST_ERIF_INVALID_MPLS_LABEL_CNT = 5990,

    /*! invalid number of Symbols in the sequence */
    NCP_ST_ERIF_INVALID_SYMBOL_SEQ_COUNT = 5991,

    /*! invalid virtual BIP_SB lookup index */
    NCP_ST_ERIF_INVALID_VIRTUAL_BIP_SB_LOOKUP_INDEX = 5992,

    /*! invalid verbose Event type */
    NCP_ST_ERIF_INVALID_VERBOSE_EVENT_TYPE = 5993,

    /*! invalid verbose packet buffer length */
    NCP_ST_ERIF_INVALID_VERBOSE_PACKET_BUFFER_LENGTH = 5994,

    /*! invalid verbose debug mode */
    NCP_ST_ERIF_INVALID_VERBOSE_DEBUG_MODE = 5995,

    /*! invalid verbose debug mode */
    NCP_ST_ERIF_INVALID_NUM_VERBOSE_BUFFERS = 5996,

    /*! invalid pcaket buffer length */
    NCP_ST_ERIF_INVALID_PACKET_BUFFER_LENGTH = 5997,

    /*! egress options table index is in use by an enabled stream. can't set.*/
    NCP_ST_ERIF_EGRESS_OPTIONS_TBL_IN_USE = 5998,

    /*! egress options table index invalid */
    NCP_ST_ERIF_EGRESS_OPTIONS_TBL_INDEX_INVALID = 5999,

    /*! Branch type invalid */
    NCP_ST_ERIF_INVALID_BRANCH_TYPE = 6000,

    /*! nesting of branches not allowed */
    NCP_ST_ERIF_BRANCH_NESTING_NOT_ALLOWED = 6001,

    /*! invalid sub buffer number */
    NCP_ST_ERIF_STREAM_INVALID_SUB_BUFF_NUM = 6002,

    /*! buffer set can't be done on primary */
    NCP_ST_ERIF_STREAM_BUFF_SET_NOT_SECONDARY = 6003,

    /*! buffer address already set to the same value.*/
    NCP_ST_ERIF_STREAM_BUFF_ADDR_ALREADY_SET = 6004,

    /*! Invalid buffer sequence count mode */
    NCP_ST_ERIF_INVALID_BUFFER_SEQUENCE_MODE = 6005,

    /*! Invalid HW Debug event Id */
    NCP_ST_ERIF_INVALID_HW_DEBUG_EVENT_ID = 6006,

    /*! Invalid HW Debug event log buffer control */
    NCP_ST_ERIF_INVALID_HW_DEBUG_EVENT_LOG_BUFFCTRL = 6007,

    /*! HW debug entry not setup */
    NCP_ST_ERIF_HW_DEBUG_ENTRY_DOES_NOT_EXIST = 6008,
    /*! Invalid Stream debug entry Id */
    NCP_ST_ERIF_INVALID_STREAM_DEBUG_ENTRY_ID = 6009,

    /*! stream debug entry not setup */
    NCP_ST_ERIF_STREAM_DEBUG_ENTRY_DOES_NOT_EXIST = 6010,

    /*! invalid watchdog id */
    NCP_ST_ERIF_INVALID_WATCHDOG_ID = 6011,

    /*! invalid monitor id */
    NCP_ST_ERIF_INVALID_MONITOR_ID = 6012,

    /*! invalid monitor window */
    NCP_ST_ERIF_INVALID_MONITOR_WINDOW = 6013,

    /*! stream does not have a monitor selected*/
    NCP_ST_ERIF_STREAM_NO_MONITOR_SEL = 6014,

    /*! stream does not have a watchdog selected*/
    NCP_ST_ERIF_STREAM_NO_WATCHDOG_SEL = 6015,

    /*! invalid watchdog expiry time */
    NCP_ST_ERIF_INVALID_WATCHDOG_EXPIRY = 6016,

    /*! Could not enable PMU_USE_MODE */
    NCP_ST_PMU_USER_ENABLE_ERR              =	7000,

   /* Special MUTEX errors */
   
   /*! Owner died while holding robust mutex */
    /* NCP_ST_PTHREAD_MUTEX_OWNER_DEAD         = 8000, */		/* Binary compat with mainline */
    /*! Wrong state set for mutex*/
    /* NCP_ST_MUTEX_WRONG_STATE                = 8001, */
    /*! Mutex type change not allowed if pool is in use */
    /* NCP_ST_MUTEX_CANNOT_CHANGE_TYPE         = 8002, */
