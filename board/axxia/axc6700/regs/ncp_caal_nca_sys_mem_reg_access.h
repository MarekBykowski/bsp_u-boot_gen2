...
#ifndef _NCP_CAAL_NCA_SYS_MEM_REG_ACCESS_H_
#define _NCP_CAAL_NCA_SYS_MEM_REG_ACCESS_H_
...
static ncp_access_map_t  ncpCaalNcaSysMem[] = {

    { 0x00000000,  0x00000010, 4, 1 },
    { 0x0000001c,  0x00000020, 4, 1 },
    { 0x00000040,  0x0000005c, 4, 1 },
    { 0x00000080,  0x00000094, 4, 1 },
    ...
    { 0x00001000,  0x00001200, 4, 4 },
    { 0x00001200,  0x000013e0, 4, 4 },
    { 0x000013e0,  0x00001400, 4, 4 },
...
#endif /* _NCP_CAAL_NCA_SYS_MEM_REG_ACCESS_H_ */
