...
#ifndef _NCP_NLINK_IPCQ_REQ_REGS_H_
#define _NCP_NLINK_IPCQ_REQ_REGS_H_
...
/*! @struct ncp_nlink_ipcq_req_double_buffer_status_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_double_buffer_status_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 25;
#endif
} ncp_nlink_ipcq_req_double_buffer_status_r_t;

/*! @struct ncp_nlink_ipcq_req_nlink_xface_ctl_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_nlink_xface_ctl_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 31;
#endif
} ncp_nlink_ipcq_req_nlink_xface_ctl_r_t;

/*! @struct ncp_nlink_ipcq_req_access_rate_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_access_rate_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 24;
#endif
} ncp_nlink_ipcq_req_access_rate_r_t;

/*! @struct ncp_nlink_ipcq_req_nlink_ctl_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_nlink_ctl_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 23;
#endif
} ncp_nlink_ipcq_req_nlink_ctl_r_t;

/*! @struct ncp_nlink_ipcq_req_axi_status_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_axi_status_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      write_req_err                             :  1;
#endif
} ncp_nlink_ipcq_req_axi_status_r_t;

/*! @struct ncp_nlink_ipcq_req_hist_cnt_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_hist_cnt_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 24;
#endif
} ncp_nlink_ipcq_req_hist_cnt_r_t;

/*! @struct ncp_nlink_ipcq_req_setup_cnt_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_setup_cnt_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 24;
#endif
} ncp_nlink_ipcq_req_setup_cnt_r_t;

/*! @struct ncp_nlink_ipcq_req_overflow_underflow_status_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_overflow_underflow_status_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 21;
#endif
} ncp_nlink_ipcq_req_overflow_underflow_status_r_t;

/*! @struct ncp_nlink_ipcq_req_core_error_status_r_t
 *  @brief Status Register
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_core_error_status_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 30;
#endif
} ncp_nlink_ipcq_req_core_error_status_r_t;

/*! @struct ncp_nlink_ipcq_req_nlink_int_status_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_nlink_int_status_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 22;
#endif
} ncp_nlink_ipcq_req_nlink_int_status_r_t;

/*! @struct ncp_nlink_ipcq_req_nlink_int_en_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_nlink_int_en_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 22;
#endif
} ncp_nlink_ipcq_req_nlink_int_en_r_t;

/*! @struct ncp_nlink_ipcq_req_nlink_int_force_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_nlink_int_force_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 22;
#endif
} ncp_nlink_ipcq_req_nlink_int_force_r_t;

/*! @struct ncp_nlink_ipcq_req_AW_smon01_NLINK_r_t
 ...
 * </tr>
 * </table>
 * Applies to: xlf --> ncp_nlink_ipcq_req_AW_smon01_NLINK_r_t
 *
 */
...
typedef struct
{
     ...
     unsigned      reserved0                                 : 16;
#endif
} ncp_nlink_ipcq_req_AW_smon01_NLINK_r_t;

#ifdef __cplusplus
}
#endif

#endif /* _NCP_NLINK_IPCQ_REQ_REGS_H_ */
