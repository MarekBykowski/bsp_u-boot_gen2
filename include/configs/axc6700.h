...
#define NETBOOT_TRACE_OFFSET			0x200000
#define CONFIG_SYS_INIT_SP_ADDR     (0x280000 + NETBOOT_TRACE_OFFSET)
#define CONFIG_SYS_MALLOC_BASE		CONFIG_SYS_INIT_SP_ADDR
#define CONFIG_SYS_MALLOC_SIZE /*0x170000*/ \
	(0x400000 + NETBOOT_TRACE_OFFSET - CONFIG_SYS_MALLOC_BASE - CONFIG_ENV_SIZE)
